...
public class ReseauCifar {
	...
	public int m; // Number of products in memory
	...
	public ReseauCifar(int m) throws IOException { 
		
		this.m = m;
		
		// Recuperation de m images formatées 
		RecuperationImageCIFAR recup = new RecuperationImageCIFAR(m);
	...
	public void GenererReseauWillshaw() {
		...
		// System.out.println("Number of connections in the network: " +
		// nb_connections);
	}
